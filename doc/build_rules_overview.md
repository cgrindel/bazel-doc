...
<pre>
write_header(<a href="#write_header-name">name</a>, <a href="#write_header-out">out</a>, <a href="#write_header-header_content">header_content</a>, <a href="#write_header-doc_provs">doc_provs</a>, <a href="#write_header-do_not_edit_warning">do_not_edit_warning</a>)
</pre>
...
| <a id="write_header-doc_provs"></a>doc_provs |  A <code>list</code> of document provider <code>struct</code> values as returned from <code>providers.create()</code>.   |  <code>[]</code> |
